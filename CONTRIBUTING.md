...
If you want to learn more about this project, read the [wiki](https://github.com/MintNetwork/chia-blockchain/wiki), or check out the [green paper](https://chia.net/assets/MintGreenPaper.pdf).
