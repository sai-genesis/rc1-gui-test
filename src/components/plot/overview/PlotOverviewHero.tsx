...
import { CardHero, Flex, Link } from '@mint/core';
import { PlotHero as PlotHeroIcon } from '@mint/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Mint. '
              }
              <Link
                target="_blank"
                href="https://github.com/MintNetwork/mint-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
